      ...
      <div className="static-container">
        ...
        <div className="disclaimer-content">
          <section className="disclaimer-section">
            ...
            <p>
              <strong>MappleFlix does not host any files on its server.</strong> All content provided on this platform 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              ...
              no liability in respect of any such content. All content available through MappleFlix remains 
            ...
            <p>
              ...
              site belong to their respective owners. MappleFlix makes no claims to own or control the 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              This site is provided for entertainment and educational purposes only. MappleFlix is a 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              Users of MappleFlix are solely responsible for:
            </p>
          ...
          <section className="disclaimer-section">
            ...
            <p>
              MappleFlix utilizes The Movie Database (TMDB) API for movie and TV show information, including:
            </p>
          ...
          <section className="disclaimer-section warning-section">
            <div className="warning-banner">
              ...
              <p>
                The developers of MappleFlix are not responsible for any legal issues that may arise from 
